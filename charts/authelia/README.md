...
| `authelia.configuration` | Configure the Authelia instance | `{"access_control":{"default_policy":"deny","rules":[{"domain":"public.example.com","policy":"bypass"},{"domain":"traefik.example.com","policy":"one_factor"},{"domain":"secure.example.com","policy":"two_factor"}]},"authentication_backend":{"file":{"path":"/opt/authelia/config/users_database.yaml"}},"jwt_secret":"a_very_important_secret","log":{"level":"debug"},"notifier":{"filesystem":{"filename":"/dev/stdout"}},"regulation":{"ban_time":300,"find_time":120,"max_retries":3},"server":{"address":"tcp://:9091"},"session":{"cookies":[{"authelia_url":"https://auth.example.com","default_redirection_url":"https://www.example.com","domain":"example.com","expiration":"1h","inactivity":"5m","name":"authelia_session","remember_me":"1d","same_site":"lax"}],"secret":"unsecure_session_secret"},"storage":{"encryption_key":"you_must_generate_a_random_string_of_more_than_twenty_chars_and_configure_this","local":{"path":"/var/lib/authelia/db.sqlite3"}},"totp":{"issuer":"authelia.com"}}` |
